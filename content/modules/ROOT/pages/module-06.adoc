...
+
image::module-06/00_Workload_VM_List.png[link=self, window=blank, width=100%]
+
...
+
image::module-06/01_vSphere_Network.png[link=self, window=blank, width=100%]
...
+
image::module-06/02_vSphere_Datastore.png[link=self, window=blank, width=100%]
...
+
image::module-06/03_MTV_Providers.png[link=self, window=blank, width=100%]
+
[TIP]
...
+
image::module-06/04_MTV_Provider_List.png[link=self, window=blank, width=100%]
+
...
+
image::module-06/05_MTV_Create_Provider.png[link=self, window=blank, width=100%]
+
...
+
image::module-06/06_MTV_Fill_Dialog.png[link=self, window=blank, width=100%]
.  Press *Create* and wait till the *Status* column is changed to *Ready*
+
image::module-06/07_MTV_Provider_Added.png[link=self, window=blank, width=100%]
...
+
image::module-06/08_MTV_NetworkMaps.png[link=self, window=blank, width=100%]
...
+
image::module-06/09_Add_VMWARE_Mapping_Network.png[link=self, window=blank, width=100%]

. Ensure the created mapping has the *Status* *Ready*.
+
image::module-06/10_List_VMWARE_Mapping_Network.png[link=self, window=blank, width=100%]

. Navigate in the left menu to *Migration* -> *StorageMaps for virtualization* and click on the *Create StorageMap* button.
+
image::module-06/11_MTV_StorageMaps.png[link=self, window=blank, width=100%]
...
+
image::module-06/12_Add_VMWARE_Mapping_Storage.png[link=self, window=blank, width=100%]

. Ensure the created mapping has the *Status* *Ready*.
+
image::module-06/13_List_VMWARE_Mapping_Storage.png[link=self, window=blank, width=100%]
////
...
+
image::module-06/14_Create_VMWARE_Plan.png[link=self, window=blank, width=100%]
+
. You will be asked to select the source provider that you intend to migrate from. Click on the *VMware* tile.
+
image::module-06/16_VMware_Source_Provider.png[link=self, window=blank, width=100%]
+
...
. Click *Next*.
+
image::module-06/17_VM_Select_VMWARE_Plan.png[link=self, window=blank, width=100%]
+
...
+
image::module-06/18_Create_Migration_Plan.png[link=self, window=blank, width=100%]
+
. You will be taken to a new screen where you will see that the plan for migration is being made ready.
+
image::module-06/19_Migration_Plan_Unready.png[link=self, window=blank, width=100%]
+
...
+
image::module-06/20_Migration_Plan_Ready.png[link=self, window=blank, width=100%]
+
. You will be presented with a confirmation box to begin the migration, click on the *Start* button.
+
image::module-06/21_Confirm_Migrate_Start.png[link=self, window=blank, width=100%]
+
. A progress bar will appear in the center of the screen along with the status of *0 of 3 VMs migrated*.
+
image::module-06/22_VMs_Migrating.png[link=self, window=blank, width=100%]
+
...
+
image::module-06/23_VMs_Migrating_Details.png[link=self, window=blank, width=100%]
+
...
+
image::module-06/24_VM_Migration_Stages.png[link=self, window=blank, width=100%]
+
...
+
image::module-06/25_Completed_VMWARE_Plan.png[link=self, window=blank, width=100%]
+
