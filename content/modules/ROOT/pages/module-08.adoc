...
+
. You can copy and paste the yaml configuration below.  This example will backup the _vmexamples_ namespace, including all metadata and resources defined, using snapshots for the PVCs and offload the snapshot to the S3 bucket using the built-in Kopia Data Mover. 
