...
image::Trilio/k8s-triliovaultIngress.PNG[]
+
. In the left navigation pane, expand *Networking* and select *Routes*. There will be four routes listed in the trilio-system project.   Click the route that ends with the '\'
+
