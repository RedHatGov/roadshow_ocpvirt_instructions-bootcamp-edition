...
+
image::Trilio/k8s-triliovaultIngress.png[]
+
. In the left navigation pane, expand *Networking* and select *Routes*. There will be four routes listed in the trilio-system project.   Click the route that ends with the backslash '/'.
+
...
. Select the tvk-instance from the list of Clusters.  
+
