...
+
image::module-05/01_Template_List.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/02_Search_Centos9.png[link=self, window=blank, width=100%]
+
. Select the three-dot menu to the far right, and click on the option to *Clone* from the menu that pops out.
+
image::module-05/03_Clone_Template.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/04_Clone_Template_Options.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/05_Clone_Details.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/06_Edit_CPU_Mem.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/07_Edit_Network.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/08_Edit_Net_Int.png[link=self, window=blank, width=100%]
+
. Next click on the *Scripts* tab at the top, and in the section called *Cloud-init* click the *Edit* button.
+
image::module-05/09_Scripts_CloudInit.png[link=self, window=blank, width=100%]
+
...
----
+
image::module-05/10_Cloud_Init_Script.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/11_User_Templates.png[link=self, window=blank, width=100%]
+
. Click on the tile and you will be prompted with the VM startup screen. Click the *Quick create VirtualMachine* button.
+
image::module-05/12_Quick_Create_Template.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/13_VM_From_Template.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/14_VM_Console.png[link=self, window=blank, width=100%]
+
...
----
+
image::module-05/15_MariaDB_Login.png[link=self, window=blank, width=100%]
...
+
image::module-05/16_Template_Catalog.png[link=self, window=blank, width=100%]
+
. Scroll down until you find the *Microsoft Windows Server 2019 VM* tile.
+
image::module-05/17_Windows_2k19_Tile.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/18_Windows_2k19_Dialog.png[link=self, window=blank, width=100%]
+
. In this dialog:
...
+
image::module-05/19_Windows_2k19_Parameters.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/20_Customize_Scripts.png[link=self, window=blank, width=100%]
+
. A new window will pop up for you to create *Sysprep* actions for your new template.
+
image::module-05/21_Sysprep.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/22_Windows_2k19_Sysprep.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/23_Edit_Boot_Media.png[link=self, window=blank, width=100%]
+
. Select the option for *Use this disk as a boot source*, and click on the *Save* button at the bottom.
+
image::module-05/24_Boot_Source.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/25_Windows_2k19_Provisioning.png[link=self, window=blank, width=100%]
+
. After a few minutes, the Virtual VM will be in *Running* status. Switch to the *Console* tab:
+
image::module-05/26_Windows_2k19_Console.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/27_Windows_PVC.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/28_Clone_Windows_PVC.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/29_Windows_Template.png[link=self, window=blank, width=100%]
